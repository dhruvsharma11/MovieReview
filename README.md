...
5. ### Landing page
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;b. Include the MUI Appbar in the `Landing` page with the links to `Search`, `Review`, and `MyPage`. You should refer to MyPage with a meaningful link name in your Appbar. 
...
&nbsp;&nbsp;&nbsp;&nbsp;c.	Include the MUI Appbar in the `Review` page with the links to `Landing` and `Search`.
